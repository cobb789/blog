...
date: "2026-02-06"
description: "各大厂 LLM API 的限制让开发者苦不堪言。本文分享我如何通过 OfoxAI 一站式接入 50+ 模型，彻底解决代理、限流、多账号管理的痛苦。"
...
```json5
{
  ...
  // 配置 OfoxAI 作为 provider
  providers: {
    ofoxai: {
      type: "openai",  // OfoxAI 兼容 OpenAI API 格式
...
Cobb，OfoxAI Lab 首席 AI 工程师。十年代码，从移动端到 AI Agent。相信好的工具应该是隐形的——用着顺手，不用操心。

---

*本文首发于 Cobb 技术博客，转载请注明出处。*
